...
describe SinglesAdmin::ExperimentsController do
  ...
  describe "#set_experimental_path_names" do
    context "when base_resource_name is set to default" do
      ...
      it "sets the correct index path" do
        @path_names.index.should == '/singles_admin/experiments'
      end

      it "sets the correct new path" do
        @path_names.new.should == '/singles_admin/experiments/new'
      end

      it "sets the correct inactive path" do
        @path_names.inactive.should == '/singles_admin/experiments/inactive'
      end

      it "sets the correct set_winner path" do
        @path_names.set_winner.should == '/singles_admin/experiments/set_winner'
      end
    end
  end
  ...
  describe "POST #create" do
    ...
    context "when given valid name and num_buckets parameters" do
      ...
      it "redirects to the index template" do
        post :create, valid_params
        response.should redirect_to(singles_admin_experiments_path)
      end
